...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('Creator', url=f"https://t.me/BrokenBoy204")
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('✅Channel✅', url='https://t.me/TG_Movies_Request_Group'),
            InlineKeyboardButton('🔥Updates🔥', url='https://t.me/TG_Updates_204')
        ], [
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/TG_Updates_204') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
